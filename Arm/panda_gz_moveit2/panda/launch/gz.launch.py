            ...
            OnProcessExit(
                ...
                on_exit=[
                    ...
                    Node(
                        ...
                        arguments=[
                            # RGB camera
                            "/world/default/model/panda/link/panda_link7/sensor/panda_rgb_camera/image@sensor_msgs/msg/Image@ignition.msgs.Image",
                            "/world/default/model/panda/link/panda_link7/sensor/panda_rgb_camera/camera_info@sensor_msgs/msg/CameraInfo@ignition.msgs.CameraInfo",

                            # Depth camera
                            "/world/default/model/panda/link/panda_link7/sensor/panda_depth_camera/depth_image@sensor_msgs/msg/Image@ignition.msgs.Image",
                            "/world/default/model/panda/link/panda_link7/sensor/panda_depth_camera/camera_info@sensor_msgs/msg/CameraInfo@ignition.msgs.CameraInfo",

                            # Point cloud
                            "/world/default/model/panda/link/panda_link7/sensor/panda_depth_camera/depth_image/points@sensor_msgs/msg/PointCloud2@ignition.msgs.PointCloudPacked"
                        ],
                        remappings=[
                            # RGB camera remaps
                            ("/world/default/model/panda/link/panda_link7/sensor/panda_rgb_camera/image", "/panda/rgb_camera/image"),
                            ("/world/default/model/panda/link/panda_link7/sensor/panda_rgb_camera/camera_info", "/panda/rgb_camera/camera_info"),

                            # Depth image and info
                            ("/world/default/model/panda/link/panda_link7/sensor/panda_depth_camera/depth_image", "/panda/depth_camera/image"),
                            ("/world/default/model/panda/link/panda_link7/sensor/panda_depth_camera/camera_info", "/panda/depth_camera/camera_info"),

                            # Point cloud
                            ("/world/default/model/panda/link/panda_link7/sensor/panda_depth_camera/depth_image/points", "/panda/depth_camera/points")
                        ],
                        parameters=[{"use_sim_time": use_sim_time}]
                    ),
